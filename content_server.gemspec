...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('content_data', '1.0.0')
  s.add_runtime_dependency('file_indexing', '1.0.0')
  s.add_runtime_dependency('file_monitoring', '1.0.0')
  s.add_runtime_dependency('log', '1.0.0')
  s.add_runtime_dependency('networking', '1.0.0')
  s.add_runtime_dependency('params', '1.0.0')
  ...
  s.add_dependency('log', '1.0.0')
  s.add_dependency('networking', '1.0.0')
  s.add_dependency('params', '1.0.0')
