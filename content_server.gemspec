...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('file_indexing', '1.0.1')
  s.add_runtime_dependency('file_monitoring', '1.0.1')
  ...
  s.add_dependency('file_indexing', '1.0.1')
  s.add_dependency('file_monitoring', '1.0.1')
