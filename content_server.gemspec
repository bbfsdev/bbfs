...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('file_indexing', '1.0.2')
  s.add_runtime_dependency('file_monitoring', '1.0.2')
  s.add_runtime_dependency('log', '1.0.1')
  s.add_runtime_dependency('networking', '1.0.1')
  s.add_runtime_dependency('params', '1.0.1')
  s.add_runtime_dependency('process_monitoring', '1.0.1')
  s.add_runtime_dependency('rake', '0.9.2.2')
  s.add_runtime_dependency('run_in_background', '1.0.1')
  s.add_dependency('content_data', '1.0.1')
  s.add_dependency('file_indexing', '1.0.2')
  s.add_dependency('file_monitoring', '1.0.2')
  s.add_dependency('log', '1.0.1')
  s.add_dependency('networking', '1.0.1')
  s.add_dependency('params', '1.0.1')
  s.add_dependency('process_monitoring', '1.0.1')
