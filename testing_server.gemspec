...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('email', '>=1.1.0')
  s.add_runtime_dependency('file_utils', '>=1.1.0')
  ...
  s.add_runtime_dependency('validations', '>=1.1.0')
  s.add_dependency('content_server', '>=1.1.0')
  s.add_dependency('content_data', '>=1.1.0')
  s.add_dependency('email', '>=1.1.0')
  s.add_dependency('file_utils', '>=1.1.0')
  ...
  s.add_dependency('validations', '>=1.1.0')
end
