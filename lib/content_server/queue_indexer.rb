    ...
    def run
      ...
      thread = Thread.new do
        while true do
          ...
          (state, is_dir, path, mtime, size, file) = @input_queue.pop
          ...
          if state == FileMonitoring::FileStatEnum::STABLE && !is_dir
            ...
            # yarondbb: TODO: Move this check into FileStat object and add the cache this info:(checksum, size_mod time)
              ...
              #checksum = ""
