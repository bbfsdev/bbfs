require 'fileutils'
require_relative 'file_generator_parameters'
require 'digest'
...
#puts Time.now
#fgp = FileGeneratorParameters.new()
#fgp.total_created_directories = 1
#fgp.total_files_in_dir = 10
#fgp.sleep_time_in_seconds = 10
#fg = FileGenerator.new(fgp)
