...
class Content
  ...
  def initialize(checksum, size, first_appearance_time, content_serializer_str = nil)
    if content_serializer_str != nil
...
class ContentInstance
  ...
  def initialize(checksum, size, server_name, device, full_path, modification_time, content_instance_serializer_str = nil)
    if content_instance_serializer_str != nil
      content_instance_serializer = ContentInstanceMessage.new
      content_instance_serializer.parse_from_string(content_instance_serializer_str)
...
class ContentData
  ...
  def initialize(content_data_serializer_str = nil)
    ...
    if (content_data_serializer_str != nil)
      content_data_serializer = ContentDataMessage.new
      content_data_serializer.parse_from_string(content_data_serializer_str)
      content_data_serializer.contents.each do |entry|
        ...
        content = Content.new(nil, nil, nil, content_serializer.serialize_to_string)
      ...
      content_data_serializer.instances.each do |entry|
        ...
        content_instance = ContentInstance.new(nil, nil, nil, nil, nil, nil, content_instance_serializer.serialize_to_string)
  ...
  def serialize
    serializer = ContentDataMessage.new
    contents.each do |key, value|
      hash_value = ContentDataMessage::HashEntry::HashValue.new
      content_serializer_str = value.serialize
      content_serializer = ContentMessage.new
      content_serializer.parse_from_string(content_serializer_str)
    ...
    instances.each do |key, value|
      hash_value = ContentDataMessage::HashEntry::HashValue.new
      instance_serializer_str = value.serialize
